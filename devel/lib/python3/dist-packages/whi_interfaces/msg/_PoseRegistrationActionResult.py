...
"""autogenerated by genpy from whi_interfaces/PoseRegistrationActionResult.msg. Do not edit."""
import codecs
import sys
...
class PoseRegistrationActionResult(genpy.Message):
  _md5sum = "492f03a5380e8554c334fd17fcbf2f4a"
  _type = "whi_interfaces/PoseRegistrationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','whi_interfaces/PoseRegistrationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PoseRegistrationActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = whi_interfaces.msg.PoseRegistrationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = whi_interfaces.msg.PoseRegistrationResult()
