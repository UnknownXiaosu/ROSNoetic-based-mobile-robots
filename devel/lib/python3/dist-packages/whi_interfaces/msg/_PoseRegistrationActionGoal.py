...
"""autogenerated by genpy from whi_interfaces/PoseRegistrationActionGoal.msg. Do not edit."""
import codecs
import sys
...
class PoseRegistrationActionGoal(genpy.Message):
  _md5sum = "660d6895a1b9a16dce51fbdd9a64a56b"
  _type = "whi_interfaces/PoseRegistrationActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','whi_interfaces/PoseRegistrationGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PoseRegistrationActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = whi_interfaces.msg.PoseRegistrationGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = whi_interfaces.msg.PoseRegistrationGoal()
